...
<head>
    ...
    <title>AntHELP - Sign Up - Senior Citizens</title>
    ...
    <div class="header">
        <nav class="navbar navbar-expand-lg text-uppercase navbar-dark position-absolute w-100">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <a href="login-page.html" class="btn btn-primary">LOGIN</a>
            </div>
        </nav>
                    ...
                    <div class="sign-form card">
                        <div class="card-body">
                            ...
                            <form action="action-signup.php" method="post" class="needs-validation" novalidate>
                                ...
                                <div class="form-group">
                                    <input required type="text" name="nric" class="form-control" placeholder="NRIC">
                                    <div class="valid-feedback">Looks Good</div>
                                ...
                                <button type="submit" class="btn w-100 btn-primary mb-3">Sign up</button>
                            </form>
                            <hr>
                            <p class="text-center">Already have an AntHelp account? <span><a class="text-info" href="login-page.html">Login</a></span></p>
                        </div>
                    </div>
