									...
									<div class="col-12 col-sm-9">
										<div class="row mt-4 mb-2 metadata-wrapper">
											<div class="col-4">
												<div class="metadata">
													<p class="card-subtitle text-muted">Job ID#</p>
													<h5 class="card-title text-dark">BCXK1</h5>
												</div>
											</div>
											<div class="col-4">
												<div class="metadata">
											...
											<div class="col-4">
												<div class="metadata">
													<p class="card-subtitle text-muted">Job Date</p>
													<h5 class="card-title text-dark">Sep 20, 2018</h5>
												</div>
											</div>
											<div class="col-4">
												<div class="metadata">
													<p class="card-subtitle text-muted">Job Time</p>
													<h5 class="card-title text-dark">2:00 PM</h5>
												</div>
											</div>
											<div class="col-4">
												<div class="metadata">
													<p class="card-subtitle text-muted">Duration</p>
													<h5 class="card-title text-dark">2 Hours</h5>
												</div>
											</div>
											<div class="col-4">
												<div class="metadata">
